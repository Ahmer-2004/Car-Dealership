...
void UserInfo();
using namespace std; 
string name,Pr,NC,Md,Fa,cnic,phno; //storing car info which is purchased... Pr for Price,NC for Car name,Md for model and Fa for fuel avg
int Pr1;  
...
string H1="Honda Accord",H2="Honda Insight",H3="Toyota Prius (Hybrid)",HM1="2023  1.8",HM2="2020  1.6",HM3="2021  1.6",HF1="13.6 km",HF2="12 km",HF3="15.2 km";
int HR1=50000,HR2=45000,HR3=43000; 
string T1="Toyota RAV4 ",T2="Ford Explorer",T3="Honda CR-V",TM1="2023    Manual",TM2="2022    Manual",TM3="2021    Manual",TF1="13 km",TF2="14 km",TF3="12.7 km";
int TT1=70000,TT2=65000,TT3=53000; 
string SUZ1="Mercedes-Benz S-Class",SUZ2="Rolls-Royce Phantom",SUZ3="BMW 7 Series",SM1="2023    Auto",SM2="2022    Auto",SM3="2022    Auto",SF1="15.6 km",SF2="14 km",SF3="14 km";
int SUZU1=90000,SUZU2=95000,SUZU3=83000;    
                                                                                                                                                              
int main()                                                                                                                                                                   
{ fstream cat;                                                                                            
	int choice,ch2;char c;
	cout<<"-----Welcome To ABC Car Rental And  Dealership-----  "<<"\n\n";
	cout<<"---------------------------------"<<endl;
				...
				case '1':
					{
				        ...
				        cout<<"Enter your choice between (a-c)"<<endl;
					cin>>p;
				switch(p)
				{
					case 'a':
	...
	switch(c)
			{
				...
				switch(p)
				{
					...
					case '2':
						{	
							cout<<"In SUV We have Following Collection for Rent:\n";
							cout<<"----------------------------------------------------------------------------"<<endl;
							cout<<"   Cars"<<" \t\t      Model "<<"\t\t       Rent/Day   "<<"\tFuel Avg"<<endl;
							cout<<"----------------------------------------------------------------------------"<<endl;
					 	...
					 	switch(p)
				{
					case 'a':
						...
						case '3':
							{
							cout<<"In COMFORT We have Following Collection for Rent:\n";
							cout<<"---------------------------------------------------------------------------------------"<<endl;
							cout<<"   Cars"<<" \t\t         Model "<<"\t\t     Rent/Day   "<<"\tFuel Avg"<<endl;
							cout<<"---------------------------------------------------------------------------------------"<<endl;
...
void pur()
{        cout<<"\n\t\t                       ABC Car Rental and Dealership - Customer Invoice                  "<<endl;
     cout<<"\t\t	///////////////////////////////////////////////////////////"<<endl;
